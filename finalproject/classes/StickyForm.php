...
<div class="$class">
    ...
    <input type="$type" class="form-control" id="{$element['id']}" name="{$element['name']}" value="$value">
    $errorOutput
</div>
HTML;
    }
...
<div class="$class">
    <label for="{$element['id']}">{$element['label']}</label>
    <textarea class="form-control" id="{$element['id']}" name="{$element['name']}">$value</textarea>
    $errorOutput
</div>
HTML;
    }
...
<div class="form-check $layoutClass">
    <input class="form-check-input" type="radio" id="{$element['id']}_$optionValue" name="{$element['name']}" value="$optionValue" $checked>
    <label class="form-check-label" for="{$element['id']}_$optionValue">$optionLabel</label>
</div>
HTML;
        }
        return <<<HTML
...
HTML;
    ...
    public function renderCheckbox($element, $class = '', $layout = 'vertical') {
        $checked = ($element['checked'] ?? false) ? 'checked' : '';
        $errorOutput = $this->renderError($element);
        $layoutClass = $layout === 'horizontal' ? 'form-check-inline' : '';
        return <<<HTML
<div class="$class">
...
HTML;
    ...
    public function renderCheckboxGroup($element, $class = '', $layout = 'vertical') {
        ...
        foreach (($element['options'] ?? []) as $index => $option) {
            ...
            $optionsHtml .= <<<HTML
<div class="form-check $layoutClass">
    <input class="form-check-input" type="checkbox" id="{$element['id']}_{$index}" name="{$element['name']}[]" value="$optionValue" $checked>
    <label class="form-check-label" for="{$element['id']}_{$index}">$optionLabel</label>
</div>
HTML;
        }
        return <<<HTML
