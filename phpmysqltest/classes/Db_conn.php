...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'tyweston';//this will be your WCC username
      $dbUsr = 'tyweston';//this will be your WCC username
      $dbPass = 'fToUcD02lgR2zlk';//this will be the password found in the video.
